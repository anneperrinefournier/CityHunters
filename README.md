# CityHunters: Paris Puzzle Trail Mobile Web Application
...
- **Anne-Perrine Fournier – porteuse du projet** : Création et configuration de l'application, déploiement, gestion des conflits de merge, API Mapbox, localisation (Ajax) et suivi des utilisateurs (Websocket), validation de la position, figma, css et html de la home, du choix des scénarii, du lobby, du jeu et de la carte. Écriture des scénarii Code Rouge et Opéra en pagaille. Travail d'édition du contenu.
...
- **Pierre-François Thomas** : Configuration de l'application, navigation drawer (JS), localisation des utilisateurs (Ajax), html et css de la page home.
