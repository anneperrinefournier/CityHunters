...
storyline_bonus = Storyline.new(
  ...
  introduction: "Vous êtes épuisé. Épuisé mais ravi, encore porté par l’adrénaline de cette journée. Deux mois intenses viennent de s’écouler dans les murs du Wagon. Votre application n’a pas crashé pendant la démonstration ( enfin on espère^^), maintenant s’ouvre devant vous le scintillement d’une soirée trépidante. Pas de controller en vue, c’est le moment d’oublier tout vos bundle install et autres folles gem, queryselector et elsif, bootstrap et fetch…c’est le moment pour un rm-rf de qualité, un reboot complet, délestez-vous de vos git push origin (master??) en fredonnant 'Ruby, c'est finiiiii, et dire que c'était le code de mon premier amoooour!' "
)
...
file = URI.open("https://img.cuisineaz.com/660x660/2013/12/20/i28721-recette-de-hachis-parmentier.webp")
...
riddle103 = Riddle.new(
  ...
  question: "Quel est le nom de la station de métro?",
  solution: "parmentier",
  motion_type: 'shifting',
  place: place102
)
...
riddle104 = Riddle.new(
  ...
  Dirige-toi vers la station de métro Parmentier et valide ta position devant l’entrée!",
  question: "Valide ta position",
  motion_type: 'shifting',
  solution: "salut",
  place: place103
)
...
# file = URI.open('https://fondationolo.ca/wp-content/uploads/2017/07/fondation-olo-bebe-a-faim.jpg')
# riddle108.photo.attach(io: file, filename: "eat_together", content_type: "image/jpg")
riddle108.save!
