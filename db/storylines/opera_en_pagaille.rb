...
riddle3 = create_or_update(
  Riddle.new(
    ...
    description: "La maison de Molière, c’est bien entendu la Comédie-Française ! Tu t’y rends rapidement, espérant ne pas manqeur le fantôme. Il doit sûrement être à la recherche de son masque, là où les costumes sont rangés… Il est logique qu’il soit venu ici, vu la collection importante de masques que la Comédie-Française doit avoir ! Tu t’apprêtes à rentrer, quand le fantôme apparaît soudain devant toi. « Erik ? » Il se retourne quand tu l’appelles, mais mets les mains sur son visage pour le cacher. « Ne me regardez pas ! J’ai perdu mon masque… Je pensais le trouver ici, mais il n’est pas là… ». Tu essayes de le consoler, puis lui explique la situation à l’Opéra : tu lui demandes de revenir. « Je ne peux pas, pas sans mon masque… C’est grâce à lui que je me cache. Il efface ma laideur. » Tu insites, mais il refuse de revenir tant qu’il n'aura pas retrouvé son masque. Tu lui proposes de l’aider à le retrouver et lui demandes s’il a vu le voleur. Il t’explique que non, mais qu’il a laissé un mot avec des indices. Le premier est la date de l’inauguration de la Comédie-Française.",
    solution: '1680',
